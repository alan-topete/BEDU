...
round(table(data.la.liga$FTHG) / margin.table(table(data.la.liga$FTHG)) *100, 2) #relative freq home team goals
round(table(data.la.liga$FTAG) / margin.table(table(data.la.liga$FTAG)) *100, 2) #relative freq away team goals
